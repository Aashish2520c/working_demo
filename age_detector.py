...
if user_input.isnumeric() and (0 < int(user_input) < 100):
    ...
    user_dob = 2021 - int(user_input)

    # well, basically age limit is 100
    age_limit = user_dob + 100

    print(f"You have entered your ages as {user_input}")
    print(f"Your birth date should be {user_dob}")
...
elif user_input.isnumeric() and (1920 < int(user_input) < 2021):
