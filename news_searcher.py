...
class Searcher:
    ...
    def manual_search(self, combined_date):
        ...
        url = f"https://newsapi.org/v2/everything?q={self.query}&from={combined_date}&sortBy=popularity&apiKey=dd40b7f73d424f11b50a5212d54908b4"
    ...
    def auto_search(self):
        ...
        url = f"https://newsapi.org/v2/everything?q={self.query}&from={date.today()}&sortBy=popularity&apiKey=dd40b7f73d424f11b50a5212d54908b4"
